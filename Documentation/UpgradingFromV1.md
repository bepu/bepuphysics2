...
| Collision events | `e.CollisionInformation.Events` | No out of the box events; [`ContactEventsDemo`](../Demos/Demos/ContactEventDemo.cs) shows how to use narrow phase callbacks to create events. |
