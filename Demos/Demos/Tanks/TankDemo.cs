...
namespace Demos.Demos.Tanks
{
    public class TankDemo : Demo
    {
        ...
        public override void Initialize(ContentArchive content, Camera camera)
        {
            ...
            //Note that this demo uses only one substep and 8 velocity iterations.
            ...
            Simulation = Simulation.Create(BufferPool, new TankCallbacks() { Properties = bodyProperties }, new DemoPoseIntegratorCallbacks(new Vector3(0, -10, 0)), (1, 8));
