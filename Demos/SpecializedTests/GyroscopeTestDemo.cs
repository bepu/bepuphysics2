...
namespace Demos.Demos
{
    ...
    public class GyroscopeTestDemo : Demo
    {
        public override void Initialize(ContentArchive content, Camera camera)
        {
            ...
            Simulation = Simulation.Create(BufferPool, new DemoNarrowPhaseCallbacks(), new GyroscopicIntegratorCallbacks(new Vector3(0, -10, 0), 0f, 0f), new SubsteppingTimestepper(4), 1);
