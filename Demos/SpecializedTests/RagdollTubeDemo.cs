...
namespace Demos.SpecializedTests
{
    ...
    public class RagdollTubeDemo : Demo
    {
        public unsafe override void Initialize(ContentArchive content, Camera camera)
        {
            ...
            Simulation = Simulation.Create(BufferPool, new SubgroupFilteredCallbacks { CollisionFilters = filters }, new DemoPoseIntegratorCallbacks(new Vector3(0, -10, 0)), new EmbeddedSubsteppingTimestepper2(3), 1);
