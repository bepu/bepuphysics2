...
namespace Demos.SpecializedTests
{
    public class ConstrainedKinematicIntegrationTest : Demo
    {
        public unsafe override void Initialize(ContentArchive content, Camera camera)
        {
            ...
            camera.Yaw = 0;
            Simulation = Simulation.Create(BufferPool, new DemoNarrowPhaseCallbacks(new SpringSettings(30, 1), 2, 1), new DemoPoseIntegratorCallbacks(new Vector3(0, -0.1f, 0), 0, 0), new SolveDescription(1, 4));
