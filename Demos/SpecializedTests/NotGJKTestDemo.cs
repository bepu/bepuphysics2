...
{
    public class NotGJKTestDemo : Demo
    {
        Buffer<LineInstance> shapeLines;
        List<NotGJKStep> steps;
        ...
        public override void Initialize(ContentArchive content, Camera camera)
        {
            ...
            Simulation = Simulation.Create(BufferPool, new DemoNarrowPhaseCallbacks(), new DemoPoseIntegratorCallbacks(new Vector3(0, -10, 0)));
            {
                ...
                steps = new List<NotGJKStep>();
                NotGJK<Cylinder, CylinderWide, CylinderSupportFinder, Cylinder, CylinderWide, CylinderSupportFinder>.FindMinimumDepth(
