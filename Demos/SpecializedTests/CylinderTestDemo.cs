...
namespace Demos.SpecializedTests
{
    public class CylinderTestDemo : Demo
    {
        ...
        public override void Initialize(ContentArchive content, Camera camera)
        {
            ...
            Simulation = Simulation.Create(BufferPool, new DemoNarrowPhaseCallbacks(), new DemoPoseIntegratorCallbacks(new Vector3(0, 0f, 0)), new EmbeddedSubsteppingTimestepper2(4), 1);
