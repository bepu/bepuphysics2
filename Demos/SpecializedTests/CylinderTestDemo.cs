...
namespace Demos.SpecializedTests
{
    public class CylinderTestDemo : Demo
    {
        ...
        public override void Initialize(ContentArchive content, Camera camera)
        {
            ...
            Simulation.Bodies.Add(BodyDescription.CreateConvexKinematic(new RigidPose(new Vector3(14, -3, 0), Quaternion.CreateFromAxisAngle(Vector3.Normalize(new Vector3(1, 0, 1)), 0)), Simulation.Shapes, new Cylinder(3f, .2f)));
