...
; partially interruptible
; No PGO data
; 0 inlinees with PGO data; 122 single block inlinees; 22 inlinees without PGO data
...
G_M000_IG02:                ;; offset=0x00CB
       ...
       vmovaps  xmmword ptr [rbp-0x1D0], xmm10
       vmovshdup xmm3, xmm8
       ...
       vcmpgtps xmm2, xmm2, xmm3
       vmovss   xmm3, dword ptr [rsi+0x04]
       vmovaps  xmm4, xmm3
       vxorps   xmm3, xmm3, xmmword ptr [reloc @RWD00]
...
G_M000_IG03:                ;; offset=0x01FD
       ...
       vmovaps  xmm2, xmmword ptr [rbp-0x1C0]
       vmovaps  xmm3, xmm2
       vsubps   xmm1, xmm3, xmm1
       vmovaps  xmm3, xmm1
       vinsertps xmm3, xmm3, xmm3, 56
 
G_M000_IG04:                ;; offset=0x032F
       ...
       vmovups  xmmword ptr [rbp-0x170], xmm2
       vmovups  xmmword ptr [rbp-0x140], xmm2
       vmovups  xmmword ptr [rbp-0x110], xmm2
       mov      byte  ptr [rbp-0x15C], 1
       mov      byte  ptr [rbp-0x12C], 0
       mov      byte  ptr [rbp-0xFC], 0
       vmovss   xmm2, dword ptr [rbp+0x40]
       vmovss   dword ptr [rbp-0x184], xmm2
...
G_M000_IG07:                ;; offset=0x04C0
       xor      r12d, r12d
       cmp      r12d, r15d
       jge      G_M000_IG12
 
G_M000_IG08:                ;; offset=0x04CC
       cmp      byte  ptr [rbp-0x190], 0
       jne      G_M000_IG12
       ...
       vbroadcastss xmm3, xmm3
       vcmpgtps xmm3, xmm3, xmm14
       vmulss   xmm5, xmm4, dword ptr [rbp-0x1A0]
       vinsertps xmm5, xmm5, xmm0, 16
       vmulss   xmm4, xmm4, dword ptr [rbp-0x198]
       vinsertps xmm4, xmm5, xmm4, 40
       vandps   xmm4, xmm4, xmm3
       vinsertps xmm0, xmm0, xmm0, 29
       vandnps  xmm0, xmm3, xmm0
       vorps    xmm0, xmm0, xmm4
       vxorps   xmm3, xmm15, xmm1
       vmovaps  xmm4, xmm10
       vmovaps  xmm5, xmm3
       vbroadcastss xmm5, xmm5
       vmulps   xmm4, xmm5, xmm4
...
G_M000_IG09:                ;; offset=0x0601
       vinsertps xmm10, xmm10, xmm4, 16
       vunpckhps xmm3, xmm3, xmm3
       vmulss   xmm3, xmm3, xmm6
       vinsertps xmm3, xmm10, xmm3, 40
...
G_M000_IG10:                ;; offset=0x06B3
       vmovss   dword ptr [rbx], xmm1
       vmovaps  xmm1, xmmword ptr [rbp-0x1A0]
       vmovsd   qword ptr [r14], xmm1
       vextractps dword ptr [r14+0x08], xmm1, 2
 
G_M000_IG11:                ;; offset=0x06CB
       vucomiss xmm2, dword ptr [rbx]
       jae      G_M000_IG12
       ...
       cmp      r12d, r15d
       vmovss   dword ptr [rbp+0x38], xmm6
       vmovss   xmm2, dword ptr [rbp-0x184]
       vmovaps  xmm10, xmmword ptr [rbp-0x1D0]
       jl       G_M000_IG08
 
G_M000_IG12:                ;; offset=0x0761
...
G_M000_IG13:                ;; offset=0x07ED
       vxorps   xmm0, xmm0, xmm0
       vmovsd   qword ptr [r13], xmm0
       vmovss   dword ptr [r13+0x08], xmm0
 
G_M000_IG14:                ;; offset=0x07FD
...
G_M000_IG08:                ;; offset=0x04EC
       ...
       vinsertps xmm15, xmm4, xmm4, 56
       vdpps    xmm2, xmm15, xmm15, -1
...
G_M000_IG09:                ;; offset=0x0646
       je       SHORT G_M000_IG11
 
G_M000_IG10:                ;; offset=0x0648
       mov      byte  ptr [rax], 1
 
G_M000_IG11:                ;; offset=0x064B
       or       esi, r8d
       cmp      byte  ptr [rax], 0
       sete     r9b
       movzx    r9, r9b
...
G_M000_IG12:                ;; offset=0x0662
       vmovss   xmm1, dword ptr [rsp+0x90]
       vdivss   xmm2, xmm11, xmm1
       vmovss   dword ptr [rsp+0x88], xmm2
       vdivss   xmm2, xmm11, xmm9
       vmovss   dword ptr [rsp+0x84], xmm2
       vdivss   xmm2, xmm11, xmm0
       vmovss   dword ptr [rsp+0x80], xmm2
       vsubps   xmm5, xmm5, xmm3
       vmulps   xmm14, xmm14, xmm15
       vpermilps xmm2, xmm14, -11
...
G_M000_IG13:                ;; offset=0x07BF
       ...
       vbroadcastss xmm9, xmm13
       vbroadcastss xmm6, xmm6
       vcmpltps xmm13, xmm9, xmm6
       vorps    xmm1, xmm13, xmm1
       vbroadcastss xmm13, xmm2
       vcmpltps xmm9, xmm9, xmm13
       vorps    xmm9, xmm9, xmm0
       vcmpltps xmm6, xmm6, xmm13
       ...
       vorps    xmm2, xmm2, xmm9
       vandnps  xmm2, xmm1, xmm2
       vorps    xmm2, xmm2, xmm6
       vmovss   xmm6, dword ptr [rsp+0xCC]
       vucomiss xmm6, xmm2
       jb       SHORT G_M000_IG14
       mov      byte  ptr [rax], 1
 
G_M000_IG14:                ;; offset=0x08B9
       vmovss   xmm2, dword ptr [rsp+0x70]
       vandps   xmm2, xmm2, xmm1
       vmovss   xmm9, dword ptr [rsp+0x6C]
       vandps   xmm9, xmm9, xmm0
       vmovss   xmm13, dword ptr [rsp+0x68]
       ...
       vxorps   xmm8, xmm2, xmmword ptr [reloc @RWD16]
       vbroadcastss xmm8, xmm8
       ...
       vpand    xmm9, xmm7, xmmword ptr [reloc @RWD80]
       vpandn   xmm13, xmm7, xmmword ptr [reloc @RWD96]
       vpor     xmm9, xmm13, xmm9
       vmovd    r10d, xmm9
       vmovd    xmm9, r10d
       vpandn   xmm9, xmm5, xmm9
       vpor     xmm8, xmm9, xmm8
       vmovd    r10d, xmm8
       vpand    xmm8, xmm5, xmmword ptr [reloc @RWD80]
       vpand    xmm9, xmm7, xmmword ptr [reloc @RWD112]
       vpandn   xmm13, xmm7, xmmword ptr [reloc @RWD128]
       vpor     xmm9, xmm13, xmm9
       vmovd    r9d, xmm9
       vmovd    xmm9, r9d
       vpandn   xmm9, xmm5, xmm9
       ...
       vpand    xmm9, xmm5, xmmword ptr [reloc @RWD112]
       vpand    xmm13, xmm7, xmmword ptr [reloc @RWD64]
