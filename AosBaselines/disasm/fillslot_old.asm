...
G_M000_IG06:                ;; offset=0x0301
       ...
       vandnps  xmm8, xmm8, xmmword ptr [rdx+0x10]
       vorps    xmm8, xmm8, xmm9
       vmovups  xmmword ptr [rdx+0x10], xmm8
       lea      r8, bword ptr [rdx+0x30]
       vandps   xmm8, xmm4, xmm6
       vandnps  xmm9, xmm6, xmmword ptr [r8]
       vorps    xmm8, xmm9, xmm8
       vmovups  xmmword ptr [r8], xmm8
       vandps   xmm8, xmm5, xmm6
       vandnps  xmm6, xmm6, xmmword ptr [r8+0x10]
       vorps    xmm6, xmm6, xmm8
       vmovups  xmmword ptr [r8+0x10], xmm6
       lea      r8, bword ptr [rdx+0x60]
       vandps   xmm4, xmm4, xmm7
       vandnps  xmm6, xmm7, xmmword ptr [r8]
       vorps    xmm4, xmm6, xmm4
       vmovups  xmmword ptr [r8], xmm4
       vandps   xmm4, xmm5, xmm7
       vandnps  xmm5, xmm7, xmmword ptr [r8+0x10]
       vorps    xmm4, xmm5, xmm4
       vmovups  xmmword ptr [r8+0x10], xmm4
 
G_M000_IG07:                ;; offset=0x03A4
...
G_M000_IG10:                ;; offset=0x064C
       mov      byte  ptr [rax], 1
 
G_M000_IG11:                ;; offset=0x064F
       or       esi, r8d
       cmp      byte  ptr [rax], 0
       sete     r9b
       movzx    r9, r9b
