...
namespace BepuPhysics
{
    public class GatherScatter
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Gather<T, TContainer>(ref Vector<T> vector, ref T sourceStart, int count) where T : struct where TContainer : struct
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Scatter<T, TContainer>(ref Vector<T> vector, ref T targetStart, int count) where T : struct where TContainer : struct
        {
