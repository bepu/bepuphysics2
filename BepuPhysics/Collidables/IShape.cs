...
namespace BepuPhysics.Collidables
{
    ...
    public interface IShapeRayBatchHitHandler
    {
    ...
    public interface ICompoundShape : IShape, IBoundsQueryableCompound
    {
        ...
        void RayTest<TRayHitHandler>(in RigidPose pose, Shapes shapeBatches, ref RaySource rays, ref TRayHitHandler hitHandler) where TRayHitHandler : struct, IShapeRayBatchHitHandler;
        int ChildCount { get; }
