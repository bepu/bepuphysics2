...
namespace BepuPhysics
{
    ...
    /// </summary>
    public class EmbeddedSubsteppingTimestepper : ITimestepper
    {
        /// <summary>
        ...
        public EmbeddedSubsteppingTimestepper(int substepCount)
        {
        ...
        public void Timestep(Simulation simulation, float dt, IThreadDispatcher threadDispatcher = null)
        {
            ...
            for (int substepIndex = 0; substepIndex < SubstepCount; ++substepIndex)
            {
                ...
                simulation.Solver.SolveStep(substepDt, threadDispatcher);
