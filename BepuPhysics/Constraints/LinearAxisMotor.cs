...
namespace BepuPhysics.Constraints
{
    ...
    public struct LinearAxisMotorProjection
    {
    ...
    public struct LinearAxisMotorFunctions : IConstraintFunctions<LinearAxisMotorPrestepData, LinearAxisMotorProjection, Vector<float>>
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Prestep(Bodies bodies, ref TwoBodyReferences bodyReferences, int count, float dt, float inverseDt, ref BodyInertias inertiaA, ref BodyInertias inertiaB,
            ref LinearAxisMotorPrestepData prestep, out LinearAxisMotorProjection projection)
        {
            ...
            LinearAxisServoFunctions.ComputeTransforms(bodies, ref bodyReferences, count, prestep.LocalOffsetA, prestep.LocalOffsetB, prestep.LocalPlaneNormal, inertiaA, inertiaB, effectiveMassCFMScale,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WarmStart(ref BodyVelocities velocityA, ref BodyVelocities velocityB, ref LinearAxisMotorProjection projection, ref Vector<float> accumulatedImpulse)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Solve(ref BodyVelocities velocityA, ref BodyVelocities velocityB, ref LinearAxisMotorProjection projection, ref Vector<float> accumulatedImpulse)
        {
    ...
    public class LinearAxisMotorTypeProcessor : TwoBodyTypeProcessor<LinearAxisMotorPrestepData, LinearAxisMotorProjection, Vector<float>, LinearAxisMotorFunctions>
    {
