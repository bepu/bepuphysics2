...
namespace BepuPhysics.Constraints.Contact
{
    ...
    /// </summary>
    public struct PenetrationLimit2Projection
    {
    ...
    public static class PenetrationLimit2
    {
        ...
        public static void Prestep(ref BodyInertias inertiaA, ref BodyInertias inertiaB, ref Vector3Wide normal, ref Contact2PrestepData prestep, float dt, float inverseDt,
            out PenetrationLimit2Projection projection)
        {
        ...
        public static void WarmStart(
            ref PenetrationLimit2Projection projection, ref BodyInertias inertiaA, ref BodyInertias inertiaB, ref Vector3Wide normal,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Solve(ref PenetrationLimit2Projection projection, ref BodyInertias inertiaA, ref BodyInertias inertiaB, ref Vector3Wide normal,
            ref Vector<float> accumulatedImpulse0,
            ref Vector<float> accumulatedImpulse1, ref BodyVelocities wsvA, ref BodyVelocities wsvB)
        {
